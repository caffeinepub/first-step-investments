...
export class Backend implements backendInterface {
    ...
    async addCategory(arg0: string, arg1: string, arg2: string, arg3: string): Promise<CategoryId> {
    ...
    async addTip(arg0: string, arg1: string, arg2: CategoryId): Promise<TipId> {
        if (this.processError) {
            try {
                const result = await this.actor.addTip(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllCategories(): Promise<Array<InvestmentCategory>> {
        if (this.processError) {
            try {
    ...
    async getAllTips(): Promise<Array<InvestmentTip>> {
        if (this.processError) {
            try {
    ...
    async getMarketTrends(): Promise<Array<MarketTrend>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMarketTrends();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTipsByCategory(arg0: CategoryId): Promise<Array<InvestmentTip>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTipsByCategory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateMarketTrend(arg0: string, arg1: number, arg2: number): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateMarketTrend(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
